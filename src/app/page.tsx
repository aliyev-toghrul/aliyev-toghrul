            ...
            {activeTab === "Resume" && (
              <section className="fade-up space-y-10">
                ...
                <div>
                  ...
                  {education.map((e, i) => (
                    <div key={i} className="glow-card bg-[#1e1e1f] border border-zinc-800 rounded-2xl p-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {skills.map((s, i) => (
                      <div key={i} className="glow-card bg-[#1e1e1f] border border-zinc-800 rounded-2xl p-5">
                        <p className="text-xs font-bold text-zinc-500 uppercase tracking-wider mb-3">{s.category}</p>
                        <div className="flex flex-wrap gap-2">
                          {s.items.map((item, j) => (
                            <span key={j} className="skill-tag text-xs px-2.5 py-1 bg-[#2a2a2a] border border-zinc-700 rounded-lg text-zinc-300">
                              {item}
                            </span>
                          ))}
                        </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {certs.map((c, i) => (
                      <div key={i} className="glow-card bg-[#1e1e1f] border border-zinc-800 rounded-2xl p-5 flex items-start gap-3">
            ...
            {activeTab === "Portfolio" && (
              <section className="fade-up space-y-6">
                ...
                <div className="space-y-6">
                  {projects.map((p, i) => (
                    <div key={i} className="glow-card bg-[#1e1e1f] border border-zinc-800 rounded-2xl p-6 group">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {p.stack.map((tech, j) => (
                          <span key={j} className="skill-tag text-[11px] px-2.5 py-1 bg-[#2a2a2a] border border-zinc-700/60 rounded-lg text-zinc-400">
                            {tech}
                          </span>
                        ))}
                      </div>
